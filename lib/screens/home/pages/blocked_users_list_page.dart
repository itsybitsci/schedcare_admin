...
class BlockedUsersListPage extends HookConsumerWidget {
  BlockedUsersListPage({super.key});
                                            ...
                                            Center(
                                              child: IconButton(
                                                onPressed: () async {
                                                  await http.delete(
                                                    Uri.parse(
                                                        'https://us-central1-schedcare.cloudfunctions.net/app/api/delete-user/${isPatient ? patient!.id : doctor!.id}'),
